        ...
        <section className="py-16 bg-navy">
          <div className="container-custom mx-auto px-4 md:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <a href="https://wa.me/60102472600?text=Hi%2C%20I%27d%20like%20to%20speak%20with%20a%20product%20specialist%20about%20the%20clinical%20evidence." target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-accent hover:bg-accent/90 text-accent-foreground font-semibold px-8 py-4 rounded-full text-lg transition-all hover:scale-105 shadow-lg">
