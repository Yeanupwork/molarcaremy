        ...
        <section className="section-padding">
          <div className="container-custom mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <button onClick={() => setActiveTab("poloxamer")} className={`px-6 py-3 rounded-full font-semibold transition-all ${activeTab === "poloxamer" ? "bg-accent text-primary shadow-button" : "bg-secondary text-primary hover:bg-secondary/80"}`}>
                Poloxamer 407
              </button>
              <button onClick={() => setActiveTab("polysorbate")} className={`px-6 py-3 rounded-full font-semibold transition-all ${activeTab === "polysorbate" ? "bg-accent text-primary shadow-button" : "bg-secondary text-primary hover:bg-secondary/80"}`}>
                Polysorbate 20
              </button>
            </div>
