...
const slides = [
  ...
  },
  {
    ...
    title: (
      <>
        <span className="font-boldonse text-yellow-400 font-bold text-[1.15em]">Antibiotic Enhancer</span> for Co-Prescription in URTI:{" "}
...
const HeroSection = () => {
  ...
  return (
    <>
    <section className="bg-navy flex items-center relative overflow-hidden pt-12 pb-6 md:pt-14 md:pb-8">
      {/* Background Pattern */}
